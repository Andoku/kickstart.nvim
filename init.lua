...
-- Edit nvim config
vim.keymap.set('n', '<leader>c', ':edit $MYVIMRC<CR>', { desc = 'Edit init.lua [C]onfig' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>.', builtin.resume, { desc = '[S]earch resume' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'cpp', 'diff', 'xml', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
